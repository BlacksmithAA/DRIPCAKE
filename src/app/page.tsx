  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-2xl w-full text-center">
        <div className="mb-6">
          <h1 className="text-5xl md:text-6xl font-bold text-cafe-800 mb-3">Dripcake</h1>
          <p className="text-lg text-cafe-600">Pan de masa madre, baguette, focaccia y más.</p>
        </div>

        <div className="card text-left max-w-md mx-auto">
          <h2 className="text-xl font-semibold mb-2">Bienvenido</h2>
          <p className="text-cafe-600 mb-4 text-sm">
        ...
        <div className="mt-8 text-xs text-cafe-500">
